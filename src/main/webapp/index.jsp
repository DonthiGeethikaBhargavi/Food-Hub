        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link text-dark fw-semibold" href="cart.jsp"><i class="fas fa-shopping-cart"></i></a></li>
                    <li class="nav-item"><a class="btn btn-primary btn-sm mx-1 login-btn" href="login.jsp">Log In</a></li>
                    <li class="nav-item"><a class="btn btn-outline-danger btn-sm logout-btn" href="logout.jsp">Log Out</a></li>
                </ul>
            </div>
        </nav>
    </div>
...
<section class="hero-section d-flex align-items-center justify-content-center">
    <img class="hero-img rounded-4 shadow-lg" src="images/foodhubimage.jpg" alt="Delicious Food">
</section>
